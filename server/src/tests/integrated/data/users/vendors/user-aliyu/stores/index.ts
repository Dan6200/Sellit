...
export const stores: StoreData[] = [
  {
    ...
    store_pages: {
      ...
      hero: {
        media: {
          0: 'https://promo_video.mov',
          1: 'https://inspire_denim_jacket.jpg',
          2: 'https://inspire_denim1.jpg',
          3: 'https://inspire_denim2.jpg',
        },
        slideshow: true,
      },
      body: {
        product_listings: { product_ids: { 0: '1', 1: '2', 2: '3' } },
      },
    },
  },
  {
    ...
    store_pages: {
      pages: [
        {
          ...
          breadcrumbs: [
            { name: 'Home', url: 'https://oraimoelectronics.com/' },
          ],
          categories: [
            {
              id: 'headphones',
              ...
              thumbnailUrl:
                'https://oraimoelectronics.com/headphones_thumb.jpg',
      ...
      hero: {
        media: {
          0: 'https://oriamo_headphones.jpg',
          1: 'https://oriamo_speaker.jpg',
          2: 'https://oriamo_fitband.jpg',
        },
        slideshow: false,
      },
      body: {
...
export const updatedStores: StoreData[] = [
  {
    ...
    store_pages: {
      ...
      hero: {
        media: {
          0: 'https://inspire_denim_jacket.jpg',
          1: 'https://inspire_denim1.jpg',
          2: 'https://inspire_denim2.jpg',
        },
        slideshow: true,
      },
      body: {
        product_listings: {
          product_ids: { 0: '3', 1: '4', 2: '5' },
        },
      },
    },
  },
